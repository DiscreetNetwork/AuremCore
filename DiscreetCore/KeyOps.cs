...
namespace DiscreetCoreLib
{
    public static class KeyOps
    {
        ...
        public static ulong XOR8(ref Key g, ulong amount)
        {
            ...
            return BinaryPrimitives.ReadUInt64BigEndian(amountBytes);
        }
        ...
        public static ulong GenAmountMask(ref Key r, ref Key pv, int i, ulong amount)
        {
            ...
            BinaryPrimitives.WriteInt32BigEndian(cdata.AsSpan(32), i);
        ...
        public static Signature Sign(ref Key x, ref Key p, byte[] m, bool hash = true)
        {
            Key mk;
            if (hash) mk = SHA256ToKey(SHA256.HashData(m));
            else mk = new Key(m);
