...
namespace DiscreetCoreLib
{
    ...
    public struct Key: IComparable
    {
        ...
        {
            return new Key(Convert.FromHexString(hex.ToUpper()));
        }
...
#nullable enable
        ...
        {
            if (b == null || b == default) throw new Exception("DiscreetCoreLib.Key.CompareTo: cannot compare to null or defaulted object");
