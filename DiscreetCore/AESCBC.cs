using DiscreetCoreLib.Extensions;
using System;
using System.IO;
    ...
    public static class AESCBC
    {
        ...
        public static CipherObject GenerateCipherObject(string passphrase)
        {
            using RNGCryptoServiceProvider rng = new();
            {
                ...
                KeyDerivation.PBKDF2(tmpKey, passhash, 64, new byte[] { 0x44, 0x69, 0x73, 0x63, 0x72, 0x65, 0x65, 0x74 }, 8, 4096, 32);
