...
{
    public class GossipUnitsPacket : IPacketBody
    {
        ...
        public GossipUnitsPacket(ushort pid, uint sid, IPreunit[] units)
        {
            Pid = pid;
            Sid = sid;
            _preunits = units;
        ...
        public GossipUnitsPacket(ushort pid, uint sid, IUnit[] units)
        {
            Pid = pid;
            Sid = sid;
            _units = units;
        ...
        public GossipUnitsPacket(ReadOnlySpan<byte> data)
        {
            Deserialize(data);
        }

        public GossipUnitsPacket(Stream s)
        {
            Deserialize(s);
        }
        ...
        public void Deserialize(ReadOnlySpan<byte> data)
        {
            ...
            data = data.Slice(6);
            (_preunits, var t) = Decoder.DeserializeChunk(data);
            sz = t + 6;
        }
