...
{
    public class FetchServerLegacy : IService
    {
        ...
        protected FetchServerLegacy(Config.Config conf, IOrderer orderer, Server netserv, Logger log)
        {
            Pid = conf.Pid;
            Orderer = orderer;
            Netserv = netserv;
        ...
        {
            var s = new FetchServerLegacy(conf, orderer, netserv, log);
            return (s, s.Trigger);
        }
